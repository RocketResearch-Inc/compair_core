...
class NotificationEvent(Base):
    ...
    pair_fingerprint: Mapped[str | None] = mapped_column(String(128), nullable=True, default=None, index=True)
    claim_fingerprint: Mapped[str | None] = mapped_column(String(128), nullable=True, default=None, index=True)
    fingerprint_version: Mapped[str | None] = mapped_column(String(32), nullable=True, default=None)
