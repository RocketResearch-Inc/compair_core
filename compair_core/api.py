...
def _serialize_notification_event(
    ...
    return {
        ...
        "pair_fingerprint": getattr(event, "pair_fingerprint", None),
        "claim_fingerprint": getattr(event, "claim_fingerprint", None),
        "fingerprint_version": getattr(event, "fingerprint_version", None),
